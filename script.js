...
function showRes() {
    ...
    if ((name != "") && (rollNum != "") && (engMarks != "" && engMarks <= "100") && (sciMarks != "" && sciMarks <= "100") && (urdMarks != "" && urdMarks <= "100") && (islMarks != "" && islMarks <= "100") && (mathsMarks != "" && mathsMarks <= "100") && (compMarks != "" && compMarks <= "100")) {
        ...
        else if (document.getElementById('percentage').value > '80'&& document.getElementById('percentage').value < '90') {
            document.getElementById('grade').innerHTML = "A"
        }
        else if (document.getElementById('percentage').value > '70'&& document.getElementById('percentage').value < '80') {
            document.getElementById('grade').innerHTML = "A"
        }
        else if (document.getElementById('percentage').value > '60'&& document.getElementById('percentage').value < '70') {
            document.getElementById('grade').innerHTML = "B"
        }
        else if (document.getElementById('percentage').value > '50'&& document.getElementById('percentage').value < '60') {
            document.getElementById('grade').innerHTML = "C"
        }
        else if (document.getElementById('percentage').value > '40'&& document.getElementById('percentage').value < '50') {
